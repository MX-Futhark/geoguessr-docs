...
![Me after mapping hundreds of milestones: tag empty, tag broken](./img/i_am_very_funny.jpg)
...
![Milestone example: 107km along the AH-48 with Bunagu 4km ahead](./img/milestones/ah48.jpg)
...
## <span id="index">Index of Road Numbers</span>
...
## <span id="roads">Roads</span>

### <span id="chhudzom-bondey">Chhudzom - Haa - Bondey</span>

#### <span id="sl1">SL-1</span>
...
![SL-1 milestone example](./img/milestones/sl1.jpg)

![SL-1 bird’s-eye view distribution](./img/distribution/sl1.png)

![SL-1 close-up distribution](./img/closeup/sl1.png)

### <span id="paro-trashigang">Paro - Trashigang</span>
...
![SL-2 milestone example](./img/milestones/sl2_latin.jpg)

![SL-2 bird’s-eye view distribution](./img/distribution/sl2_latin.png)

![SL-2 close-up distribution](./img/closeup/sl2_latin.png)

#### <span id="sl2_biscriptal">གཞུང་ལམ ༢ ↵ SL-2</span>
...
![གཞུང་ལམ ༢ ↵ SL-2 milestone example](./img/milestones/sl2_biscriptal.jpg)

![གཞུང་ལམ ༢ ↵ SL-2 bird’s-eye view distribution](./img/distribution/sl2_biscriptal.png)

![གཞུང་ལམ ༢ ↵ SL-2 close-up distribution](./img/closeup/sl2_biscriptal.png)

#### <span id="uncoated">Uncoated milestones without any information</span>
...
![Uncoated milestone example](./img/milestones/uncoated.jpg)

![Uncoated milestone bird’s-eye view distribution](./img/distribution/uncoated.png)

![Uncoated milestone close-up distribution](./img/closeup/uncoated.png)

#### <span id="nh2">གཞུང་ལམ-༢ ↵ NH-2</span>
...
![གཞུང་ལམ-༢ ↵ NH-2 milestone example](./img/milestones/nh2.jpg)

![གཞུང་ལམ-༢ ↵ NH-2 bird’s-eye view distribution](./img/distribution/nh2.png)

![གཞུང་ལམ-༢ ↵ NH-2 close-up distribution](./img/closeup/nh2.png)

#### <span id="sl02">གཞུང་ལམ་༠༢ ↵ SL_02</span>
...
![གཞུང་ལམ་༠༢ ↵ SL_02 milestone example](./img/milestones/sl02.jpg)

![གཞུང་ལམ་༠༢ ↵ SL_02 bird’s-eye view distribution](./img/distribution/sl02.png)

![གཞུང་ལམ་༠༢ ↵ SL_02 close-up distribution](./img/closeup/sl02.png)

#### <span id="pnh2">གཞུང་ལམ ༢ ↵ PNH-2</span>

Near the Bumthang/Mongar/Lhuntse dzongkhag tripoint, there is a small clusters of "[གཞུང་ལམ ༢](#dictionary) ↵ PNH-2" milestones.

![གཞུང་ལམ ༢ ↵ PNH-2 milestone example](./img/milestones/pnh2.jpg)

![གཞུང་ལམ ༢ ↵ PNH-2 bird’s-eye view distribution](./img/distribution/pnh2.png)

![གཞུང་ལམ ༢ ↵ PNH-2 close-up distribution](./img/closeup/pnh2.png)

#### <span id="pnh_latin">PNH</span>

Most of Mongar dzongkhag uses "PNH" for the Paro - Trashigang road.

![PNH milestone example](./img/milestones/pnh_latin.jpg)

![PNH bird’s-eye view distribution](./img/distribution/pnh_latin.png)

![PNH close-up distribution](./img/closeup/pnh_latin.png)

#### <span id="pnh_biscriptal">གཞུང་ལམ ↵ PNH</span>
...
![གཞུང་ལམ ↵ PNH milestone example](./img/milestones/pnh_biscriptal.jpg)

![གཞུང་ལམ ↵ PNH bird’s-eye view distribution](./img/distribution/pnh_biscriptal.png)

![གཞུང་ལམ ↵ PNH close-up distribution](./img/closeup/pnh_biscriptal.png)

#### <span id="zhunglam2">གཞུང་ལམ-༢ ↵ ZHUNGLAM-2</span>

The road section from Yadi to Trashigang uses "[གཞུང་ལམ-༢](#dictionary) ↵ ZHUNGLAM-2".

![གཞུང་ལམ-༢ ↵ ZHUNGLAM-2 milestone example](./img/milestones/zhunglam2.jpg)

![གཞུང་ལམ-༢ ↵ ZHUNGLAM-2 bird’s-eye view distribution](./img/distribution/zhunglam2.png)

![གཞུང་ལམ-༢ ↵ ZHUNGLAM-2 close-up distribution](./img/closeup/zhunglam2.png)

#### <span id="coated_no_info_nh2">Coated milestones without any information</span>
...
![Coated milestone without info along the Paro - Trashigang road example](./img/milestones/coated_no_info.jpg)

![Coated milestone without info along the Paro - Trashigang road bird’s-eye view distribution](./img/distribution/coated_no_info.png)

![Coated milestone without info along the Paro - Trashigang road close-up distribution](./img/closeup/coated_no_info_nh2.png)
...
![Coated milestone without info east of Phuentsholing close-up distribution](./img/closeup/coated_no_info_east_of_phuentsholing.png)

### <span id="phuentsholing-thimpu">Phuentsholing - Thimphu</span>

#### <span id="ah48">AH-48</span>
...
![AH-48 milestone example](./img/milestones/ah48.jpg)

![AH-48 bird’s-eye view distribution](./img/distribution/ah48.png)

![AH-48 close-up distribution](./img/closeup/ah48.png)

### <span id="wangdue-phodrang-tsirang">Wangdue Phodrang - Tsirang</span>

#### <span id="sl4">SL-4</span>
...
![SL-4 milestone example](./img/milestones/sl4.jpg)

![SL-4 bird’s-eye view distribution](./img/distribution/sl4.png)

![SL-4 close-up distribution](./img/closeup/sl4.png)

### <span id="sopsokha-punakha">Sopsokha - Punakha</span>

#### <span id="dr">DR</span>

There are a few district roads (DRs) in the country, but interestingly, only the one west of Punakha is numbered as just "DR".

![DR milestone example](./img/milestones/dr.jpg)

![DR bird’s-eye view distribution](./img/distribution/dr.png)

![DR close-up distribution](./img/closeup/dr.png)

### <span id="chuzomsa-punakha">Chuzomsa - Punakha</span>
...
![FR milestone example](./img/milestones/fr.jpg)

![FR bird’s-eye view distribution](./img/distribution/fr.png)

![FR close-up distribution](./img/closeup/fr.png)

### <span id="tsirang-dagana">Tsirang - Dagana</span>
...
![DISTRICT ROAD bird’s-eye view distribution](./img/distribution/district_road_latin.png)

![DISTRICT ROAD close-up distribution](./img/closeup/district_road_latin.png)

#### <span id="district_road_tibetan">རྫོང་ཁག་འགྲུལ་འཁོར་ལམ</span>

"[རྫོང་ཁག་འགྲུལ་འཁོར་ལམ](#dictionary)" (the equivalent of "DISTRICT ROAD" in Tibetan script) can be found in the last ¾<sup>ths</sup> of the Tsirang - Dagana road.

![རྫོང་ཁག་འགྲུལ་འཁོར་ལམ milestone example](./img/milestones/district_road_tibetan.jpg)

![རྫོང་ཁག་འགྲུལ་འཁོར་ལམ bird’s-eye view distribution](./img/distribution/district_road_tibetan.png)

![རྫོང་ཁག་འགྲུལ་འཁོར་ལམ close-up distribution](./img/closeup/district_road_tibetan.png)

#### <span id="district_road_biscriptal">རྫོང་ཁག་འགྲུལ་འཁོར་ལམ ↵ DISTRICT ROAD</span>

"[རྫོང་ཁག་འགྲུལ་འཁོར་ལམ](#dictionary) ↵ DISTRICT ROAD" is found all throughout the Tsirang - Dagana road, whereas monoscriptal versions of the same road number can only be found in the last ¾<sup>ths</sup>.

![རྫོང་ཁག་འགྲུལ་འཁོར་ལམ ↵ DISTRICT ROAD milestone example](./img/milestones/district_road_biscriptal.jpg)

![རྫོང་ཁག་འགྲུལ་འཁོར་ལམ ↵ DISTRICT ROAD bird’s-eye view distribution](./img/distribution/district_road_biscriptal.png)

![རྫོང་ཁག་འགྲུལ་འཁོར་ལམ ↵ DISTRICT ROAD close-up distribution](./img/closeup/district_road_biscriptal.png)

#### <span id="coated_info_district_road">Coated milestones with information</span>
...
![Coated milestone with info along the Tsirang - Dagana road example](./img/milestones/coated_info_district_road.jpg)

![Coated milestone with info along the Tsirang - Dagana road bird’s-eye view distribution](./img/distribution/coated_info.png)

![Coated milestone with info along the Tsirang - Dagana road close-up distribution](./img/closeup/coated_info_district_road.png)
...
![Coated milestone with info along the road northwest of Walakha close-up distribution](./img/closeup/coated_info_northwest_of_walakha.png)
...
### <span id="gelephu-tsirang">Gelephu - Tsirang</span>

#### <span id="zhunglam5">གཞུང་ལམ-༥ ↵ ZHUNGLAM-5</span>

The Gelephu - Tsirang is consistently numbered as "[གཞུང་ལམ-༥](#dictionary) ↵ ZHUNGLAM-5".

![གཞུང་ལམ-༥ ↵ ZHUNGLAM-5 milestone example](./img/milestones/zhunglam5.jpg)

![གཞུང་ལམ-༥ ↵ ZHUNGLAM-5 bird’s-eye view distribution](./img/distribution/zhunglam5.png)

![གཞུང་ལམ-༥ ↵ ZHUNGLAM-5 close-up distribution](./img/closeup/zhunglam5.png)

### <span id="gelephu-trongsa">Gelephu - Trongsa</span>
...
![གཞུང་ལམ-༤ ↵ NH-4 milestone example](./img/milestones/nh4_biscriptal.jpg)

![གཞུང་ལམ-༤ ↵ NH-4 bird’s-eye view distribution](./img/distribution/nh4_biscriptal.png)

![གཞུང་ལམ-༤ ↵ NH-4 close-up distribution](./img/closeup/nh4_biscriptal.png)

#### <span id="coated_no_info_nh4">Coated milestones without any information</span>
...
![Coated milestone without info along the NH-4 example](./img/milestones/coated_no_info.jpg)

![Coated milestone without info along the NH-4 bird’s-eye view distribution](./img/distribution/coated_no_info.png)

![Coated milestone without info along the NH-4 close-up distribution](./img/closeup/coated_no_info_nh4.png)
...
### <span id="mongar-lhuntse">Mongar - Lhuntse</span>

The Mongar - Lhuntse has two names. The transition occurs roughly at the dzongkhag border.

#### <span id="dr46">དྲི་ཨར ༤༦ ↵ DR46</span>

In Mongar dzongkhag, the Mongar - Lhuntse road is known as "[དྲི་ཨར ༤༦](#dictionary) ↵ DR46".

![དྲ་ཨར ༤༦ ↵ DR46 milestone example](./img/milestones/dr46.jpg)

![དྲ་ཨར ༤༦ ↵ DR46 bird’s-eye view distribution](./img/distribution/dr46.png)

![དྲ་ཨར ༤༦ ↵ DR46 close-up distribution](./img/closeup/dr46.png)

#### <span id="dr47">དྲི་ཨར ༤༧ ↵ DR47</span>
...
![དྲི་ཨར ༤༧ ↵ DR47 milestone example](./img/milestones/dr47.jpg)

![དྲི་ཨར ༤༧ ↵ DR47 bird’s-eye view distribution](./img/distribution/dr47.png)

![དྲི་ཨར ༤༧ ↵ DR47 close-up distribution](./img/closeup/dr47.png)

### <span id="trashigang-trashiyangtse">Trashigang - Trashiyangtse</span>

#### <span id="snh">SNH</span>
...
![SNH milestone example](./img/milestones/snh.jpg)

![SNH bird’s-eye view distribution](./img/distribution/snh.png)

![SNH close-up distribution](./img/closeup/snh.png)

#### <span id="snh_trailing_hyphen">SNH-</span>
...
![SNH- milestone example](./img/milestones/snh_trailing_hyphen.jpg)

![SNH- bird’s-eye view distribution](./img/distribution/snh_trailing_hyphen.png)

![SNH- close-up distribution](./img/closeup/snh_trailing_hyphen.png)

### <span id="trashigang-samdrup-jongkhar">Trashigang - Samdrup Jongkhar</span>

#### <span id="coated_info_trashigang_samdrup_jongkhar">Coated milestones with information</span>
...
![Coated milestone with info along the Trashigang - Samdrup Jongkhar road example](./img/milestones/coated_info_trashigang_samdrup_jongkhar.jpg)

![Coated milestone with info along the Trashigang - Samdrup Jongkhar road bird’s-eye view distribution](./img/distribution/coated_info.png)

![Coated milestone with info along the Trashigang - Samdrup Jongkhar roadclose-up distribution](./img/closeup/coated_info_trashigang_samdrup_jongkhar.png)
...
### <span id="tshelingkhor-gypsum">Tshelingkhor - Gypsum</span>

#### <span id="dr42_biscriptal">དྲི་ཨར-༤༢ ↵ DR-42</span>

The initial part of the Tshelingkhor - Gypsum road is numbered as "[དྲི་ཨར-༤༢](#dictionary) ↵ DR-42".

![དྲི་ཨར-༤༢ ↵ DR-42 milestone example](./img/milestones/dr42_biscriptal.jpg)

![དྲི་ཨར-༤༢ ↵ DR-42 bird’s-eye view distribution](./img/distribution/dr42_biscriptal.png)

![དྲི་ཨར-༤༢ ↵ DR-42 close-up distribution](./img/closeup/dr42_biscriptal.png)

#### <span id="dr42_latin">DR_42</span>

The final part of the Tshelingkhor - Gypsum road is numbered as "DR_42".

![DR_42 milestone example](./img/milestones/dr42_latin.jpg)

![DR_42 bird’s-eye view distribution](./img/distribution/dr42_latin.png)

![DR_42 close-up distribution](./img/closeup/dr42_latin.png)

## Appendices

### <span id="dzongkha-romanization">Romanization of Dzongkha</span>
...
### <span id="dictionary">Dzongkha-English Dictionary for Road Numbers</span>
